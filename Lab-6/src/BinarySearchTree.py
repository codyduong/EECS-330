...
# assume using str BST
class TreeMap(BinarySearchTree[str]):
    def __init__(self):
        super().__init__()

    def put(self, key: int, value: Any) -> None:
        root_node: TreeNode[Any] | None = self._root_node
    ...
    def get(self, key: int) -> str | None:
        node = self.search(key, "key") # the way this is handled is super dumb and unintuitive but it was easier than reconfiguring my 268 lab LOL
