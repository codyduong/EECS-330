...
BinarySearchTreeNodeSubnode = NewType("BinarySearchTreeNodeSubnode", "TreeNode[Any]")
...
class TreeNode(Generic[BinarySearchTreeNodeValue]):
    ...
    def __init__(
        self,
        key: int,
        value: BinarySearchTreeNodeValue = None,
        ...
        self._value = (
            value or key
        )  # if we don't specify a value, assume key and value are one in the same
